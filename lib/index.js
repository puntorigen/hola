    ...
    ***************************************************************************** */
    ...
    var Grow = /** @class */ (function (_super) {
        ...
        Grow.prototype.process = function () {
            return __awaiter(this, void 0, void 0, function () {
                var db, templates, template_, template, linkedin, _i, _a, country, newUsersProfile, newUsers, newPeople, _b, newUsers_1, person, exists, test;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 6:
                            ...
                            _c.label = 7;
                        case 7:
                            if (!(_b < newUsers_1.length)) return [3 /*break*/, 13];
    ...
    var Invite = /** @class */ (function (_super) {
        ...
        Invite.prototype.process = function () {
            return __awaiter(this, void 0, void 0, function () {
                var linkedin, newUsersProfile, newUsers;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            linkedin = new LinkedIn(this.arg.user, this.arg.pass);
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, linkedin.createProfileSearch({ keywords: 'nodejs', country: CountryType.Chile, language: LanguageType.English, distance: 2 })];
                        case 2:
