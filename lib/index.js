    ...
    ***************************************************************************** */
    ...
    var DB = /** @class */ (function () {
        ...
        DB.prototype.init = function () {
            return __awaiter(this, void 0, void 0, function () {
                var keys_, keys_, keys_;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!this.data.schema['testing']) {
                                keys_ = ["email", "num", "date"];
                            ...
                            if (!this.data.schema['templates']) {
                                keys_ = ["name", "exclude", "country", "exclude_people", "max_grow", "max_invite", "invitation_message"];
                            ...
                            if (!this.data.schema['profiles']) {
                                keys_ = ["firstName", "lastName", "sourceUserName", "templateUsed", "status", "invitationSent", "invitationDate", "messageSent", "messageDate", "distance", "dateAdded"];
        ...
        DB.prototype.push = function (table, data) {
            ...
            if (table in this.data.schema) {
                ...
                console.log('valid data for table', { table: table, data: data, valid: valid });
                if (!valid)
                    return false;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, db.push('testing', {
                                    email: 'p@p.com',
                                    num: 2,
                                    date: new Date()
                                })];
    ...
    var hola = /** @class */ (function () {
        ...
        hola.prototype.test = function (arg) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: 
                        //test db
                        return [4 /*yield*/, (new cmds.TestDB(arg)).run()];
                        case 1:
                            //test db
                            _a.sent();
                            return [2 /*return*/];
